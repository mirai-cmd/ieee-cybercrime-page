async function downloadBadFile() {
  ...
  var text = `Prajwal ne boldiya toh kar liya scan, now enjoy this file as gift :)\n\nMerry Christmas!!\n\n${
    geo_data
      ? `Your public IP address: ${geo_data.ip}\nCity : ${geo_data.city}\nRegion : ${geo_data.region}\n`
      : ""
  }\nThis is a test.\nIf you are seeing this then its for the best,\nthis is one of the ways how dangerous files are used to cause problems.\nThank you for being a part of this experiment.\nStay safe and have a nice day :)`;
